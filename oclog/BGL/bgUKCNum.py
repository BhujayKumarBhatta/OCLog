...
class BGLog:
    ...
    def __init__(self, logpath='C:\ML_data\Logs', 
                 ...
                 batch_size=32, 
                 clean_part_1=True, clean_part_2=True, clean_time_1=True, clean_part_4=True, clean_time_2=True, clean_part_6=True,
                ):
...
#         self.tk_path = os.path.join(self.save_dir, 'bgltk.pkl')
        ...
        self.clean_part_1=clean_part_1
        self.clean_part_2=clean_part_2
        self.clean_time_1=clean_time_1
        self.clean_part_4=clean_part_4
        self.clean_time_2=clean_time_2
        self.clean_part_6=clean_part_6
