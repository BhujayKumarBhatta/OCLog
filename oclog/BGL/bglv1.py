...
class BGLog:
    ...
    def __init__(self, **kwargs):        
        ...
        self.rm_time_stamp = kwargs.get('rm_time_stamp', True)
        self.rm_msg_source = kwargs.get('rm_msg_source', True)
        self.rm_ip_address = kwargs.get('rm_ip_address', True)
        self.rm_signs_n_punctuations = kwargs.get('rm_signs_n_punctuations', True)
        self.rm_white_space = kwargs.get('rm_white_space', True)
        self.save_dir = kwargs.get('save_dir', 'data')
        self.pkl_file = kwargs.get('pkl_file', 'bgl_ukc.pkl')
        self.tk_file = kwargs.get('tk_file', 'bgl_tk.pkl')
        ...
        self.ablation = kwargs.get('ablation', 28000)
