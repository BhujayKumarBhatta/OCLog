...
from oclog.BGL.mxl import MixedLog as BGLLog
...
class MixedLog:
    ...
    def __init__(self, **kwargs):        
        ...
        self.mixed_logs = kwargs.get('mixed_logs', True)
        ...
        self.classes = kwargs.get('classes', ['0', '1', '2', '3',])
        # if self.mixed_logs:
        ...
        self.hdfs_selected_cls = kwargs.get('hdfs_selected_cls', 'both')  # #   other values are 'hdfs_normal and hdfs_anomaly'
    ...
    def get_mix_log_df(self, **kwargs):
        '''
        hdfs_selected_cls values are  'both', 'hdfs_normal' and 'hdfs_anomaly'
        '''
        hdfs_selected_cls = kwargs.get('hdfs_selected_cls', self.hdfs_selected_cls)
        ...
        selected_labels = (bgl_df.label == '0') | (bgl_df.label == '1')
        ...
        #############################################################
        hdfs_class_map = {"hdfs_normal": "2", "hdfs_anomaly": "3", }
        ...
        if hdfs_selected_cls != 'both':
            hdfs_cls_chosen = hdfs_class_map[hdfs_selected_cls]
            print(f'taking only {hdfs_cls_chosen} as per parameter hdfs_selected_cls={hdfs_selected_cls}')
            hdfs_selected_labels = (hdfs_df.label == hdfs_cls_chosen)
            hdfs_df = hdfs_df[hdfs_selected_labels]
        #########################################################
