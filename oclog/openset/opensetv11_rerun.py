...
#             features = penultimate_layer.output
    ...
    def plot_centroids(self, **kwargs ):
        ...
        scaled_tout = tsne_features
        scaled_cout = tsne_centroids        
        ...
        if centroid_class_color:
            ...
            ax5.scatter(scaled_cout[:, 0], scaled_cout[:, -1],  s=200, c=fixed_color_maps[:self.num_classes], cmap='tab10', marker=r'd', edgecolors= 'k')
